          ...
          <ul class="nav">
            ...
            <li class="nav-item <?php
                                if (isset($_GET['page']) == null) {
                                  ...
                                  echo $_GET['page'] == 'checkout' ? 'active' : '';
                                } ?>">
            ...
            <li class="nav-item <?php
                                if (isset($_GET['page']) == null) {
                                  ...
                                  $_GET['page'] == 'ulasan' ? 'active' : '';
                                } ?>">
              <a class="nav-link" href="?page=ulasan">
                <i class="icon-paper menu-icon"></i>
                <span class="menu-title">Ulasan User</span>
              </a>
            </li>
          </ul>
        </nav>
