...
if (isset($_POST['submit'])) {
    ...
    if ($profil != "") {
        ...
        if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
            move_uploaded_file($file_tmp, '../../../pages/user/profil/img/' . $nama_gambar_baru); //memindah file gambar ke folder gambar
            ...
            if (!$result) {
                ...
                echo "<script>alert('Berhasil diubah.');window.location='../../index.php?page=user';</script>";
            }
        } else {
            //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
            echo "<script>alert('Ekstensi gambar hanya boleh JPG atau PNG.');window.location='../../index.php?page=user';</script>";
        }
    } else {
        // jalankan query UPDATE berdasarkan ID yang produknya kita edit
        ...
        if (!$result) {
            ...
            //tampil alert dan akan redirect ke halaman index.php
            //silahkan ganti index.php sesuai halaman yang akan dituju
            echo "<script>alert('Data berhasil diubah.');window.location='../../index.php?page=user';</script>";
        }
    }
}
