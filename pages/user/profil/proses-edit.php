...
if (isset($_POST['submit'])) {
    ...
    if ($profil != "") {
        ...
        if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
            ...
            $query = "UPDATE user SET profil = '$nama_gambar_baru', nama='$nama',no='$no',email='$email',alamat='$alamat',password='$password', level='$level' WHERE id_user='$id_user'";
        ...
        // jalankan query UPDATE berdasarkan ID yang produknya kita edit
        $query = "UPDATE user SET nama='$nama',no='$no',email='$email',alamat='$alamat',password='$password', level='$level'";
